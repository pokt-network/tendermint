...
- [security/p2p: prevent peers who errored being added to the peer_set ](https://github.com/pokt-network/tendermint/pull/75)
- [update dependencies](https://github.com/pokt-network/tendermint/pull/74)
- [minor fixes](https://github.com/pokt-network/tendermint/pull/73)
